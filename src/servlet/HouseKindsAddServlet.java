 ...
 * 这是楼房类型添加的Servlet
 */
@WebServlet(name = "HouseKindsAddServlet")
public class HouseKindsAddServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //发出获取请求
        String jsonString = JSON.toJSONString(new JsonTransportType(houseKinds1, "", adminId, "houseKindsAdd"));
